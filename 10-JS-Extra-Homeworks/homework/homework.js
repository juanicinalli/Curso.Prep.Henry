...
function asAmirror(str) {
  ...
  var fraseEspejo = str.split(' ').map(function (palabra) {//separa cada palabra y es un elemento del array "the" "henry"

    return palabra.split('').reverse().join('');

  }).join(' '); //unen elementos de array con un espacio en el medio, se transforma en string
